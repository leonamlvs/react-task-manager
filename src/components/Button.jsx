...
const variants = {
  ...
  secondary:
    'flex h-11 items-center justify-center rounded-full glass-full px-4 text-text-secondary-light dark:text-text-secondary-dark transition-all duration-300 interactive-hover hover:shadow-md interactive-press',
  danger:
